...
mod tests {
    ...
    fn test_cpu_decode_rra() {
        ...
        assert_eq!(1, instruction.num_bytes);
        assert_eq!(4, instruction.clock_ticks);
        assert_eq!(Operation::RRA, instruction.operation);
    }
    ...
    #[test]
    fn test_cpu_decode_ld_mem_reg_hl_b() {
        let op_code: u8 = 0x70;
    ...
    #[test]
    fn test_cpu_decode_ld_mem_reg_hl_c() {
        let op_code: u8 = 0x71;
    ...
    #[test]
    fn test_cpu_decode_ld_mem_reg_hl_d() {
        let op_code: u8 = 0x72;
    ...
    #[test]
    fn test_cpu_decode_ld_mem_reg_hl_e() {
        let op_code: u8 = 0x73;
    ...
    #[test]
    fn test_cpu_decode_ld_mem_reg_hl_h() {
        let op_code: u8 = 0x74;
    ...
    #[test]
    fn test_cpu_decode_ld_mem_reg_hl_l() {
        let op_code: u8 = 0x75;
    ...
    fn test_cpu_decode_halt() {
        ...
        assert_eq!(1, instruction.num_bytes);
        assert_eq!(4, instruction.clock_ticks);
        assert_eq!(Operation::HALT, instruction.operation);
    }

    #[test]
    fn test_cpu_decode_ld_mem_reg_hl_a() {
        let op_code: u8 = 0x77;
    ...
    fn test_cpu_decode_and_a_mem() {
        ...
        assert_eq!(1, instruction.num_bytes);
        assert_eq!(8, instruction.clock_ticks);
        assert_eq!(Operation::ANDAMEM, instruction.operation);
    }

    #[test]
    fn test_cpu_decode_and_a_a() {
        let op_code: u8 = 0xA7;
    ...
    #[test]
    fn test_cpu_decode_prefixed_rrc_b() {
        let op_code: u8 = 0x08;
    ...
    #[test]
    fn test_cpu_decode_prefixed_rrc_c() {
        let op_code: u8 = 0x09;
    ...
    #[test]
    fn test_cpu_decode_prefixed_rrc_d() {
        let op_code: u8 = 0x0A;
    ...
    #[test]
    fn test_cpu_decode_prefixed_rrc_e() {
        let op_code: u8 = 0x0B;
    ...
    #[test]
    fn test_cpu_decode_prefixed_rrc_h() {
        let op_code: u8 = 0x0C;
    ...
    #[test]
    fn test_cpu_decode_prefixed_rrc_l() {
        let op_code: u8 = 0x0D;
    ...
    #[test]
    fn test_cpu_decode_prefixed_rrc_hl() {
        let op_code: u8 = 0x0E;
        ...
        assert_eq!(1, instruction.num_bytes);
        assert_eq!(16, instruction.clock_ticks);
        assert_eq!(Operation::RRCHL, instruction.operation);
    }

    #[test]
    fn test_cpu_decode_prefixed_rrc_a() {
        let op_code: u8 = 0x0F;
    ...
    #[test]
    fn test_cpu_decode_prefixed_rr_c() {
        let op_code: u8 = 0x19;
    ...
    #[test]
    fn test_cpu_decode_prefixed_rr_d() {
        let op_code: u8 = 0x1A;
    ...
    #[test]
    fn test_cpu_decode_prefixed_rr_e() {
        let op_code: u8 = 0x1B;
    ...
    #[test]
    fn test_cpu_decode_prefixed_rr_h() {
        let op_code: u8 = 0x1C;
    ...
    #[test]
    fn test_cpu_decode_prefixed_rr_l() {
        let op_code: u8 = 0x1D;
    ...
    #[test]
    fn test_cpu_decode_prefixed_rr_hl() {
        let op_code: u8 = 0x1E;
        ...
        assert_eq!(1, instruction.num_bytes);
        assert_eq!(16, instruction.clock_ticks);
        assert_eq!(Operation::RRHL, instruction.operation);
    }

    #[test]
    fn test_cpu_decode_prefixed_rr_a() {
        let op_code: u8 = 0x1F;
    ...
    #[test]
    fn test_cpu_decode_prefixed_sra_b() {
        let op_code: u8 = 0x28;
    ...
    #[test]
    fn test_cpu_decode_prefixed_sra_c() {
        let op_code: u8 = 0x29;
    ...
    #[test]
    fn test_cpu_decode_prefixed_sra_d() {
        let op_code: u8 = 0x2A;
    ...
    #[test]
    fn test_cpu_decode_prefixed_sra_e() {
        let op_code: u8 = 0x2B;
    ...
    #[test]
    fn test_cpu_decode_prefixed_sra_h() {
        let op_code: u8 = 0x2C;
    ...
    #[test]
    fn test_cpu_decode_prefixed_sra_l() {
        let op_code: u8 = 0x2D;
    ...
    #[test]
    fn test_cpu_decode_prefixed_sra_hl() {
        let op_code: u8 = 0x2E;
        ...
        assert_eq!(1, instruction.num_bytes);
        assert_eq!(16, instruction.clock_ticks);
        assert_eq!(Operation::SRAHL, instruction.operation);
    }

    #[test]
    fn test_cpu_decode_prefixed_sra_a() {
        let op_code: u8 = 0x2F;
    ...
    #[test]
    fn test_cpu_decode_prefixed_bit_0_b() {
        let op_code: u8 = 0x40;
    ...
    #[test]
    fn test_cpu_decode_prefixed_bit_hl_0() {
        let op_code: u8 = 0x46;
